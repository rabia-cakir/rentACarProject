...
public class AdditionalServiceManager implements AdditionalServiceService{
	...
	public DataResult<List<AdditionalServiceResponse>> findAllByRentalId(int rentalId) {
		...
		List<AdditionalServiceResponse> additionalServiceResponse=additionalServices.stream().map(
				additionalService->modelMapperService.forResponse().map(additionalService, AdditionalServiceResponse.class))
